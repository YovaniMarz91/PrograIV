...
class categoria{
    ...
    private function validarDatos(){
        if( empty(trim($this->datos['codigo'])) && $this->datos['accion']!='get_data' ){
            $this->respuesta['msg'] = 'Por favor digite el codigo del cliente';
        }
        if( empty(trim($this->datos['nombre'])) && $this->datos['accion']!='get_data' ){
            $this->respuesta['msg'] = 'Por favor digite el nombre del cliente';
        }
        if( empty(trim($this->datos['direccion'])) && $this->datos['accion']!='get_data' ){
            $this->respuesta['msg'] = 'Por favor digite la direccion del cliente';
        }
        if( empty(trim($this->datos['zona'])) && $this->datos['accion']!='get_data' ){
            $this->respuesta['msg'] = 'Por favor digite la zona del cliente';
        }
